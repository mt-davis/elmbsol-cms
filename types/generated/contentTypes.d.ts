...
export interface ApiApproachStepApproachStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'approach_steps';
  info: {
    description: 'Define, design, and deliver steps from the homepage';
    displayName: 'Approach Step';
    pluralName: 'approach-steps';
    singularName: 'approach-step';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::approach-step.approach-step'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Featured customer or program transformation stories';
  ...
  attributes: {
    approach: Schema.Attribute.RichText & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    outcome: Schema.Attribute.RichText & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage marketing content for Elm Business Solutions';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valueProps: Schema.Attribute.Component<'shared.feature-item', true>;
    whyClientsBringUsIn: Schema.Attribute.Component<'shared.bullet-item', true>;
  };
}
...
export interface ApiPartnerTypePartnerType extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Organizations Elm Business Solutions is built to support';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Core service offerings shown on the marketing site';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global company, footer, and contact settings';
  ...
  attributes: {
    capabilityStatementUrl: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::approach-step.approach-step': ApiApproachStepApproachStep;
